...
class Requests {
  ...
  Requests.fromJson(Map<String, dynamic> json) {
    ...
    customerDetails = json['customerDetails'].cast<String>();
    requestedItems = json['requestedItems'].cast<String>();
  ...
  Requests.fromDocumentSnapshot(DocumentSnapshot<Map<String, dynamic>> doc)
      : requestID          = doc.id,
        ...
        requestedItems     = doc.data()!["requestedItems"],
